...
) => (parent: unknown, args: TArgs, context: { req: express.Request }, info: GraphQLResolveInfo) => Promise<any>;

export const isAuthenticated: MiddlewareFunction<any> = (resolve) => async (parent, args, ctx, info) => {
