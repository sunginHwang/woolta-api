...
type ResolverFunction<TArgs, TResult> = (
  parent: unknown,
  args: TArgs,
...
export const isAuthenticated =
  <TArgs, TResult>(resolve: ResolverFunction<TArgs, TResult>) =>
  async (parent: unknown, args: TArgs, ctx: { req: express.Request }, info: GraphQLResolveInfo): Promise<TResult> => {
    //const accessToken = ctx.cookies.get(ACCESS_TOKEN_NAME);
    const accessToken =
      'eyJhbGciOiJIUzUxMiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjEzLCJsb2dpblR5cGUiOiJ1c2VyIiwiaWF0IjoxNzE2OTg1MjgxLCJleHAiOjE3MTc1OTAwODF9.Qe4am6ymNlyqU38-NkzR-IqDJMlHZXaR8O4akexah7Mt7ZDmZfcXSSbaJvCfi-AUtTxU7T-h-kvrM2r7gmK3Gg';
